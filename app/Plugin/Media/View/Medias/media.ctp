...
<div class="item <?php if($thumbID && $media['id'] === $thumbID): ?>thumbnail<?php endif; ?>">
		...
		<div class="actions">
			...
			<?php endif; ?>
			<?php echo $this->Html->link(__d('media',"Smazat"),array('action'=>'delete',$media['id']),array('class'=>'del')); ?>
			<?php if ($editor): ?>
		...
		<div class="expand">
			...
			<table>
				...
				<tr>
					...
					<td>
						<p><a href="" class="submit"><?php echo __d('media',"Insérer dans l'article"); ?></a> <?php echo $this->Html->link(__d('media',"Smazat"),array('action'=>'delete',$media['id']),array('class'=>'del')); ?></p>
					</td>
				</tr>
