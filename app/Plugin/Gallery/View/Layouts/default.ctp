...
<!--                            <ul class="nav navbar-nav">
    ...
    <?php
    echo $this->Html->link(
            'Albums', array('controller' => 'gallery', 'action' => 'index', 'plugin' => 'gallery')
    )
    ?>
                                </li>
                            </ul>-->
                            <ul class="nav navbar-nav pull-right">
                                <li>
                                    <a href="javascript:window.open('','_self').close();" class="text-danger"><span class="glyphicon glyphicon-remove"></span>zavřít</a>
                                </li>
                            </ul>
                        </div>
                    </div>
