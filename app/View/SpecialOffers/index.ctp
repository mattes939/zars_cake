<div class="specialOffers index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $specialOffer['SpecialOffer']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $specialOffer['SpecialOffer']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $specialOffer['SpecialOffer']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $specialOffer['SpecialOffer']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
