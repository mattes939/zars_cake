...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Address Type'), ['action' => 'edit', $addressType['AddressType']['id']]); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Address Type'), ['action' => 'delete', $addressType['AddressType']['id']], ['confirm' => __('Are you sure you want to delete # %s?', $addressType['AddressType']['id'])]); ?> </li>
