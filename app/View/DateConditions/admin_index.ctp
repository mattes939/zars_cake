<div class="dateConditions index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $dateCondition['DateCondition']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $dateCondition['DateCondition']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $dateCondition['DateCondition']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $dateCondition['DateCondition']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
