...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), ['action' => 'delete', $this->Form->value('House.id')], ['confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('House.id'))]); ?></li>
