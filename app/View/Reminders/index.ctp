<div class="reminders index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), ['action' => 'view', $reminder['Reminder']['id']]); ?>
			<?php echo $this->Html->link(__('Edit'), ['action' => 'edit', $reminder['Reminder']['id']]); ?>
			<?php echo $this->Form->postLink(__('Delete'), ['action' => 'delete', $reminder['Reminder']['id']], ['confirm' => __('Are you sure you want to delete # %s?', $reminder['Reminder']['id'])]); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
